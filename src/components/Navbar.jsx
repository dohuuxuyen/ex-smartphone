  ...
  return (
    <div className=" h-[70px] bg-[#F7FAF9] fixed inset-x-0 top-0 z-[999] sm:overflow-hidden">
      <div className=" h-[100%] flex items-center w-[100%] max-w-[1200px] justify-between sm:px-2 mx-auto ">
        {!openMenu ? (
          <>
            <div className="hidden sm:block sm:fixed sm:top-0 sm:left-[-200px] sm:bottom-0 sm:bg-[#ccc] sm:opacity-50 sm:mt-[70px] sm:w-[200px] sm:ease-linear sm:duration-300"></div>
            <ul className="flex sm:fixed sm:right-[-200px] sm:top-0 sm:bottom-0 sm:bg-[#F7FAF9] sm:mt-[70px]  sm:items-center sm:py-[200px] sm:w-[200px] sm:flex-col sm:text-[25px] sm:ease-linear sm:duration-300">
          ...
          <>
            <div
              onClick={handleModal}
              className="hidden sm:block sm:fixed sm:top-0 sm:left-0 sm:bottom-0 sm:bg-[#ccc] sm:opacity-50 sm:mt-[70px] sm:w-[200px] sm:ease-linear sm:duration-300"
            ></div>
            <ul className="flex sm:fixed sm:right-0 sm:top-0 sm:bottom-0 sm:bg-[#F7FAF9] sm:mt-[70px]  sm:items-center sm:py-[200px] sm:w-[200px] sm:flex-col sm:text-[25px] sm:ease-linear sm:duration-300">
              <li onClick={handleRemoveMenu} className="sm:mb-1">
                <NavLink to="/" className="py-2 mr-3 font-semibold opacity-50">
                  TRANG CHỦ
                </NavLink>
        ...
        <NavLink
          to="/"
          className="ml-[-5%] text-2xl font-semibold text-red-500 sm:ml-0 sm:text-[16px] sm:w-[100px] sm:text-center sm:leading-[1.2]"
        >
          EX SMARTPHONE
        </NavLink>
        <div className="flex ">
