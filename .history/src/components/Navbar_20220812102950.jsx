  ...
  return (
    <div className="w-screen h-[70px] border border-gray-500 bg-[#F7FAF9]">
      <div className="w-[100%] max-w-[1200px] h-[100%] flex items-center justify-between mx-auto">
        <ul className="flex">
          <li>
            <NavLink to="/" className="py-2 mr-3 font-semibold opacity-70">
              TRANG CHỦ
            </NavLink>
          </li>
          <li>
            <NavLink
              to="/products"
              className="py-2 mr-3 font-semibold opacity-70"
            >
              SẢN PHẨM
            </NavLink>
          </li>
          <li>
            <NavLink to="/about" className="py-2 mr-3 font-semibold opacity-70">
              GIỚI THIỆU
            </NavLink>
          </li>
          <li>
