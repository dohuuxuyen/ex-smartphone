    ...
    <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px]">
      ...
      <div className="grid grid-cols-4 gap-3 ">
        <div className="">
          ...
          <p className="ml-3 cursor-pointer p-1 mb-1  opacity-70">Iphone</p>
          <p className="ml-3 cursor-pointer p-1 mb-1  opacity-70">Samsung</p>
        ...
        <div className="grid grid-cols-3 col-start-2 col-end-5 gap-10 ">
          {data.map((d) => (
            <div className="text-center">
              <img
                className="h-[319px] w-[319px] object-cover p-5 border rounded-md bg-[#F7FAF9]"
                src={d.src[0]}
                alt=""
              />
