    ...
    <>
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px] sm:px-2">
        ...
        <div className=" flex items-center justify-between  mx-auto overflow-hidden">
          ...
          <div
            onClick={handleLeft}
            className="absolute left-5 top-[50%] text-4xl cursor-pointer opacity-50 sm:top-[10%]"
          >
            <FaAngleLeft />
          </div>
          <div
            onClick={handleRight}
            className="absolute right-5 top-[50%] text-4xl cursor-pointer opacity-50 sm:top-[10%]"
          >
            <FaAngleRight />
          </div>
        </div>
