...
const Products = () => {
  ...
  const FilterProducts = (e) => {
    const updateListFilter = filter.filter((x) => x.category === e);
    ...
    <>
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px] sm:px-2">
        ...
        <div className="mt-8 mb-12 w-[50%] text-justify sm:w-[100%]">
          <p className="text-[#adadad] leading-5 sm:text-[14px]">
        ...
        <div className="grid grid-cols-4 gap-3 mb-[50px] sm:flex flex-col">
          <div className="">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:gap-x-2 sm:mb-3">
              <div>
                <label
                  onClick={() => FilterProducts("samsung")}
                  className={
                    isCheckbox === "radio-1"
                      ? "ml-3 cursor-pointer p-1 mb-1  opacity-70 outline-none flex items-center active-brand"
                      : "ml-3 cursor-pointer p-1 mb-1  opacity-70 outline-none flex items-center "
                  }
                >
                  <input
                    className="mr-2"
          ...
          <div className="grid grid-cols-3 col-start-2 col-end-5 gap-10 sm:grid-cols-2">
            {filter.map((product) => (
              <div key={product.id} className="text-center sm:flex sm:flex-col">
                <img
                  className="h-[319px] w-[319px] object-contain p-5 border rounded-md bg-[#F7FAF9] sm:h-[200px]"
                  src={product.src[0]}
                  alt=""
                />
                <h3 className="mt-4 font-medium sm:flex-1">{product.title}</h3>
