    ...
    <div className=" h-[70px] bg-[#F7FAF9] fixed inset-x-0 top-0 z-[999] sm:overflow-hidden">
      <div className=" h-[100%] flex items-center w-[100%] max-w-[1200px] justify-between sm:px-2 mx-auto ">
        {!openMenu ? (
          ...
          <ul className="flex sm:fixed sm:right-0 sm:top-0 sm:bottom-0 sm:bg-[#F7FAF9] sm:mt-[70px] sm:justify-center sm:items-center sm:py-[200px] sm:w-[200px] sm:flex-col sm:text-[25px] sm:ease-linear">
