    ...
    <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px]">
      ...
      <div className="flex">
        ...
        <div className="w-[569px] h-[584px]">
          <img
            className="w-[100%] h-[100%] object-contain border mx-5 p-3 rounded-md bg-[#F7FAF9]"
        ...
        <div className="ml-20 mt-5">
          ...
          <div>
            <h2 className="uppercase font-semibold text-[13px] mb-2">Giá</h2>
            {product.sizes.map((sss, index) => (
              <p>{size ? sss.price[index] : sss.price[0]}</p>
            ))}
          </div>
          <div>
            ...
            <div className="flex">
              {product.colors.map((color, index) => (
                <div
                  ...
                  className={
                    colors === index
                      ? "w-8 h-8 flex border border-[2px] border-[#adadad] rounded-[50%] mr-3 mt-2 cursor-pointer active-color"
                      : "w-8 h-8 flex border border-[2px] border-[#adadad] rounded-[50%] mr-3 mt-2 cursor-pointer"
                  }
