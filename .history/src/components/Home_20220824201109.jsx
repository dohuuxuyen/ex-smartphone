  ...
  return (
    <>
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px] sm:px-2">
        ...
        <div className=" bg-[#F7FAF9] flex items-center justify-center sm:mt-[320px]">
          <div className="w-[1076px] flex justify-between flex-col my-10">
            <h2 className="text-[39px] font-semibold text-center mb-10">
              SẢN PHẨM MỚI
            </h2>
            <div className="grid grid-cols-4 sm:grid">
              {data
