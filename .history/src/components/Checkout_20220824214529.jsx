                    ...
                    <div className="flex h-[100px] mb-1">
                      ...
                      >
                        ...
                        <div className="flex w-[100%] items-center sm:flex-col">
                          ...
                          <div className="flex w-[70px] items-center border justify-center text-[16px] border-[#adadad] rounded-md mr-2 sm:items-start sm:w-[100%]">
                            <input
                              type="text"
                              className="w-[70%] outline-none text-center sm:text-left"
