              ...
              {data
                ...
                .map((d, index) => (
                  <div key={index} className="m-auto text-center">
                    ...
                    <p className="mt-3 mb-5">{d.sizes[0].price}</p>
                    <NavLink
                      to={`/products/${d.id}`}
              ...
              {data
                ...
                .map((d, index) => (
                  <div className="m-auto text-center">
                    ...
                    <NavLink
                      to={`products/${d.id}`}
                      className="border rounded border-black bg-black text-white font-semibold mb-10 p-2 hover:bg-white hover:text-black block w-[120px] flex justify-center"
                    >
                      CHỌN MUA
                    </NavLink>
                  </div>
