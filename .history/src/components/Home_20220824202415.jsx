      ...
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px] sm:px-2">
        ...
        <div className="flex items-center justify-center">
          <div className="w-[1076px] flex justify-between flex-col ">
            <h2 className="text-[39px] font-semibold text-center my-10 sm:text-[32px]">
              SẢN PHẨM BÁN CHẠY
            </h2>
              ...
              {data
                ...
                .map((d, index) => (
                  ...
                  >
                    ...
                    <NavLink
                      to={`products/${d.id}`}
                      className="border rounded border-black bg-black text-white font-semibold mb-10 p-2 hover:bg-white hover:text-black block w-[120px] sm:mb-4"
                    >
                      CHỌN MUA
                    </NavLink>
                  </div>
