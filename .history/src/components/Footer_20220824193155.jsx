  ...
  return (
    <div className="bg-[#F7FAF9] flex items-center ">
      <div className="bg-[#F7FAF9] w-[100%] max-w-[1200px] mx-auto grid grid-cols-4 sm:grid-cols-2 sm:mx-2">
        <div className="">
          <h2 className="font-semibold mb-5 sm:text-[16px]">TỔNG ĐÀI HỖ TRỢ</h2>
          <p>Liên hệ đặt hàng: 1800 1111</p>
          <p className="my-3">Thắc mắc đơn hàng: 1800 2222</p>
          <p>Góp ý, khiếu nại: 1800 333</p>
        </div>
        <div className="">
          <h2 className="font-semibold mb-5 sm:text-[16px]">VỀ CHÚNG TÔI</h2>
          <p>Giới thiệu</p>
        ...
        <div className="">
          <h2 className="font-semibold mb-5 sm:text-[16px]">
            CHĂM SÓC KHÁCH HÀNG
          </h2>
        ...
        <div className="">
          <h2 className="font-semibold mb-5 sm:text-[16px]">EX SMARTPHONE</h2>
