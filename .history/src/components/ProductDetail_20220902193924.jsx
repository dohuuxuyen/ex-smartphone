...
const ProductDetail = ({
  ...
  const [product, setProduct] = useState([productDetail[0]]);
  // console.log(product);
  ...
  //     const productDetail = await data.filter((x) => x.id == productID.id);
  //     setProduct(await productDetail[0]);
  //   };
  //   getProductDetail();
  // }, []);
  ...
  return (
    <>
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px] sm:px-2">
        ...
        <div className="flex">
          <div className="w-[100px] h-[137px] sm:hidden">
          ...
          <div className="w-[100%] h-[100%] flex sm:flex-col">
            <img
              className="w-[569px] h-[584px] object-contain border mx-5 p-3 rounded-md bg-[#F7FAF9] sm:mx-0 sm:h-[300px]"
              src={product.src[tabIndex]}
              alt=""
            />
            <div className="ml-20 mt-5 sm:ml-0">
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <NavLink
                    to="/checkout"
                    className="uppercase font-semibold px-4 py-2 border border-[#adadad] rounded-md bg-[#000] text-[#fff]"
                  >
                    Mua ngay
                  </NavLink>
                </div>
        ...
        <div className="my-10 w-[685px] sm:w-[100%]">
          <h1 className="text-[20px] uppercase font-semibold">
            Giới thiệu sản phẩm
          </h1>
          <p className="text-justify leading-5 my-5 sm:text-[14px]">
            {product.desc}
          </p>
        </div>
      </div>
