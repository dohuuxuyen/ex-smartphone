...
const Navbar = () => {
  return (
    <div className="h-[70px] bg-[#F7FAF9] fixed">
      <div className="w-[100%] max-w-[1200px] h-[100%] flex items-center justify-between mx-auto fixed inset-x-0 top-0">
        <ul className="flex">
          <li>
        ...
        <div className="ml-[-15%] text-xl font-semibold text-red-500">
          EX SMARTPHONE
        </div>
        <div className="flex ">
