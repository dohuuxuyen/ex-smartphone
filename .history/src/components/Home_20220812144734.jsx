  ...
  return (
    <div className="w-[100%] max-w-[1200px] mx-auto">
      ...
      <div className="border h-[calc(100vh-70px)] bg-[#F7FAF9] flex items-center justify-center">
        <div className="border border-red-500 w-[1076px] h-[500px] flex justify-between flex-col">
            ...
            {data
              ...
              .map((d, index) => (
                <div className="m-auto text-center">
                  <img
                    key={index}
                    className="w-[224px] h-[281px] border object-cover"
                    src={d.newsProducts}
                    alt=""
                  />
                  <h3 className="mt-4">{d.title}</h3>
                  <p className="my-3">{d.sizes[0].price}</p>
                  <button className="border rounded border-black bg-black text-white font-semibold p-2 hover:bg-while hover:text-black">
                    CHỌN MUA
                  </button>
                </div>
              ))}
