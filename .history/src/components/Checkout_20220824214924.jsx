                ...
                {state.map((cartItem) => {
                  ...
                  return (
                    <div className="flex h-[100px] mb-1">
                      <div
                        key={cartItem.id}
                        className="h-[100px] border mb-2 flex  py-3 rounded-md sm:w-[100%]"
                      >
                        <img
                        ...
                        <div className="flex w-[100%] items-center sm:flex-col">
                          ...
                          <div className="flex w-[70px] border items-center  justify-center text-[16px] border-[#adadad] rounded-md mr-2 ">
                            <input
                              type="text"
