...
import { deleteAllCartItem } from "../redux/actions/actions";
...
const Checkout = ({ colorsOther, sizePrice, tabIndex }) => {
  ...
  const handleSuccessCheckout = (cartItem) => {
    dispatch(deleteAllCartItem(cartItem));
  };
            ...
            <div className="w-[49%] border rounded-md sm:w-[100%]">
                    ...
                    <div className="flex h-[100px] mb-1">
                      ...
                      >
                        ...
                        <div className="flex w-[100%] items-center sm:flex-col">
                          ...
                          <div className="mx-5 w-[120px] text-center font-medium sm:my-1 sm:mx-0 sm:w-[100%] sm:text-left text-[16px]">
              ...
              <div className="px-2">
                ...
                {checkName && checkEmail && checkPhone && checkAddress ? (
                  <NavLink
                    to="/success"
                    onClick={() => handleSuccessCheckout(clearCartItem)}
