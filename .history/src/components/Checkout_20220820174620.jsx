            ...
            <div className="w-[49%] border rounded-md">
              <div className="w-[100%] p-2 max-h-[520px] overflow-y-scroll border-b-[1px]">
                {state.map((cartItem) => {
                  ...
                  return (
                    <div className="flex h-[100px] mb-1 justify-between">
                      <div
                        key={cartItem.id}
                      ...
                      >
                        ...
                        <div className="flex w-[30px] items-center border justify-center text-[16px] border-[#adadad]">
                          <input
                            type="text"
              ...
              <div className="px-2">
                ...
                <button
                  className="py-2 w-[100%] bg-black text-white cursor-pointer rounded-md"
                  type="submit"
                >
                  Hoàn tất đơn hàng
                </button>
