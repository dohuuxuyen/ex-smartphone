...
const Navbar = ({ activeUser }) => {
  ...
  return (
    <div className="h-[70px] bg-[#F7FAF9] fixed inset-x-0 top-0 z-[999]">
      <div className="w-[100%] max-w-[1200px] h-[100%] flex items-center justify-between mx-auto hidden">
        <ul className="flex">
          <li>
        ...
        <div className="ml-[-5%] text-xl font-semibold text-red-500">
          EX SMARTPHONE
        </div>
        <div className="flex ">
          {activeUser ? (
            ...
            <NavLink
              to="/login"
              className="flex items-center border rounded border-black bg-white font-semibold p-2 hover:bg-black hover:text-white mr-2"
            >
