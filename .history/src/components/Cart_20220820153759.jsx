  ...
  return (
    <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px]">
      ...
      <div className="mt-[30px] flex">
        ...
        <div className="w-[400px] h-[233px] p-5 border">
          <h2>Bạn đang có {totalQty} sản phẩm trong giỏ hàng</h2>
          <div className="flex justify-between items-center py-3">
            <h3>Thành tiền</h3>
            <p className="text-[26px] font-semibold">{total} VND</p>
          </div>
          <button className="w-[100%] uppercase text-white bg-black py-3 rounded-md mb-2">
            Đặt hàng
          </button>
          <NavLink
            to="/checkout"
            className="w-[100%] uppercase text-white bg-black py-3 text-center rounded-md block"
          >
            Tiếp tục mua hàng
          </NavLink>
        </div>
