  ...
  return (
    <div className=" h-[70px] bg-[#F7FAF9] fixed inset-x-0 top-0 z-[999]">
      <div className=" h-[100%] flex items-center w-[100%] max-w-[1200px] justify-between mx-auto sm:px-2 ">
        {!openMenu ? (
          <ul className="flex sm:fixed sm:right-[-200px] sm:top-0 sm:bottom-0 sm:bg-[#F7FAF9] sm:mt-[70px] px-[40px] sm:py-[200px] w-[200px]  sm:flex-col ">
          ...
          <ul className="flex sm:fixed sm:right-0 sm:top-0 sm:bottom-0 sm:bg-[#F7FAF9] sm:mt-[70px] sm:px-[40px] sm:py-[200px] w-[200px] sm:flex-col sm:animate-bounce">
            <li className="sm:mb-1">
              <NavLink to="/" className="py-2 mr-3 font-semibold opacity-50">
                TRANG CHỦ
              </NavLink>
