...
const Footer = () => {
  return (
    <div className="h-[355px] bg-[#F7FAF9] flex items-center ">
      <div className="h-[215px] w-[100%] max-w-[1200px] mx-auto grid grid-cols-4 sm:grid-cols-1 sm:mx-2 sm:overflow-hidden">
        <div className="">
