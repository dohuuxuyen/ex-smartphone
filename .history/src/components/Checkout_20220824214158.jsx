                    ...
                    <div className="flex h-[100px] mb-1">
                      ...
                      >
                        ...
                        <div className="flex w-[100%] items-center sm:flex-col">
                          ...
                          <div className="mx-5 w-[120px] text-center font-medium sm:my-1 sm:mx-0 sm:text-left">
                            {cartItem.sizes[sizePrice].price} đ
                          </div>

                          <div className="flex w-[70px] items-center border justify-center text-[16px] border-[#adadad] rounded-md mr-2 sm:w-[100%]">
                            <input
                              type="text"
