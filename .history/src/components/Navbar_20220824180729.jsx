...
const Navbar = ({ activeUser }) => {
  ...
  return (
    <div className=" h-[70px] bg-[#F7FAF9] fixed inset-x-0 top-0 z-[999]">
      <div className=" h-[100%] flex items-center w-[100%] max-w-[1200px] justify-between mx-auto sm:px-2 sm:overflow-hidden">
        ...
        {!openMenu ? (
          <div className="sm:text-[32px]" onClick={handleMenu}>
            <AiOutlineMenu />
          </div>
        ) : (
