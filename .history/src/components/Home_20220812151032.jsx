  ...
  return (
    <div className="w-[100%] max-w-[1200px] mx-auto">
      ...
      <div className="bg-white mt-12">
        <div className="flex items-center h-[84px] w-[23%] border">
          <BiShoppingBag className="h-10 w-10 mx-5" />
          <div>
            <h3 className="font-semibold text-[16px]">Miễn phí giao hàng</h3>
            <span>Miễn phí ship với đơn hàng > 2 sản phẩm</span>
          </div>
        </div>
      </div>
    </div>
