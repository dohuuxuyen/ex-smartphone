            ...
            <div className="flex ">
              {product.sizes.map((sp, index) => (
                <div
                  ...
                  className={
                    size === index
                      ? "border border-[#adadad] cursor-pointer mr-4 p-2 rounded-lg active-color"
            ...
            <div className="flex">
              {product.colors.map((color, index) => (
                <div
                  ...
                  className={
                    size === index
                      ? "w-8 h-8 flex border border-[#adadad] rounded-[50%] mr-3 mt-2 cursor-pointer active-color"
                      : "w-8 h-8 flex border border-[#adadad] rounded-[50%] mr-3 mt-2 cursor-pointer"
                  }
