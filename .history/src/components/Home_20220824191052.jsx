  ...
  return (
    <>
      <div className="w-[100%] max-w-[1200px] mx-auto mt-[70px]">
        ...
        <div className=" flex items-center justify-between w-[400vw] mx-auto overflow-hidden sm:px-2">
          <div className="h-[calc(100vh-102px)] w-[400vw] sm:overflow-hidden  flex relative z-[-1] ease-linear">
            {dataHome.map((d, index) => (
              <div
                key={index}
                style={{ transform: `translateX(-${currentSlide * 100}vw)` }}
                className="h-[90%] w-[100vw] sm:h-[70%]"
              >
                <img
          ...
          <div
            onClick={handleRight}
            className="absolute right-5 top-[50%] text-4xl cursor-pointer opacity-50"
          >
            <FaAngleRight />
          </div>
        </div>
