...
const Home = () => {
  ...
  return (
    <div className="w-[100%] max-w-[1200px] h-[calc(100vh-70px)] mx-auto">
      <div>Uư đãi giảm 10% khi thanh toán trả trước</div>
      <div className=" flex items-center justify-between mx-auto overflow-hidden relative">
        <div className=" w-[400vw] flex">
          {dataHome.map((d) => (
            <div
