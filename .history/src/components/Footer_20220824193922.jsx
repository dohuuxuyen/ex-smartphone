    ...
    <div className="bg-[#F7FAF9] flex items-center ">
      <div className="bg-[#F7FAF9] w-[100%] max-w-[1200px] mx-auto grid grid-cols-4 sm:gap-5 sm:grid-cols-2 sm:mx-2 sm:py-10">
        <div className="text-[13px]">
          <h2 className="text-[14px] font-semibold mb-5">TỔNG ĐÀI HỖ TRỢ</h2>
          <p>Liên hệ đặt hàng: 1800 1111</p>
          <p className="my-3">Thắc mắc đơn hàng: 1800 2222</p>
          <p>Góp ý, khiếu nại: 1800 333</p>
        </div>
        <div className="text-[13px]">
          <h2 className="text-[14px] font-semibold mb-5">VỀ CHÚNG TÔI</h2>
          <p>Giới thiệu</p>
        ...
        <div className="text-[13px]">
          <h2 className="text-[14px] font-semibold mb-5">EX SMARTPHONE</h2>
