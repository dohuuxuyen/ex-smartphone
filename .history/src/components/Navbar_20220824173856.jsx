      ...
      <div className="w-[100%] max-w-[1200px] h-[100%] flex items-center justify-between mx-auto">
        ...
        <div className="flex ">
          {activeUser ? (
            ...
            <NavLink
              to="/login"
              className="flex items-center border rounded border-black bg-white font-semibold p-2 hover:bg-black hover:text-white mr-2 sm:text-[10px] sm:h-[30px] sm:mr-0"
            >
          ...
          <NavLink
            to="/cart"
            className="flex items-center border rounded border-black bg-white font-semibold p-2 hover:bg-black hover:text-white sm:text-[10px]  sm:h-[30px] sm:mr-0"
          >
