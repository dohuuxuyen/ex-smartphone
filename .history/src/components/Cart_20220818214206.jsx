          ...
          {state.map((cartItem, index) => (
            ...
            >
              <img
                ...
                src={cartItem.src[props.tabIndex]}
                alt=""
              />

              <div className="w-[340px] font-medium">
                {cartItem.title} - {cartItem.colors[props.colors]} -
                {cartItem.sizes[props.size].size}
              </div>

              <div className="mx-5 w-[120px] text-center font-medium">
                {cartItem.sizes[props.size].price}
              </div>
              ...
              <div className="flex w-[120px] items-center border text-[16px] border-[#adadad]">
                ...
                <input className="w-[70%] outline-none text-center"></input>
                <button
